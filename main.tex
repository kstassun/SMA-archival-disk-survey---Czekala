...
AS 209          & 16:49:15.30 & -14:22:08.6 & K3--K6 & & 3-2 & $130 \pm 50$ & \citet{vanleeuwen07} \\
...
\begin{equation}
\Sigma(r) = \Sigma_c \left (\frac{r}{r_c} \right)^{- \gamma} \exp \left [- \left ( \frac{r_\textrm{cav}}{r} \right)^{\gamma_c} \right ]  \exp \left[ - \left(\frac{r}{r_c} \right)^{2 - \gamma} \right]
\end{equation}
...
\subsection{Vertical temperature gradient model}

Here, we relax the assumption of a vertically isothermal disk, and instead adopt a more sophisticated parameterization that permits $T(r,z)$. This structure originally detailed by CITE Dartois 03, and used by Rosenfeld13, Williams and Best 14.

The disk midplane temperature and atmosphere temperature are described by two power laws, with a smooth transition between them. Parameters describe the shape of this transition.
